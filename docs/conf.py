# -*- coding: utf-8 -*-
#
# iterseg documentation build configuration file, created by
...
project = u'iterseg'
copyright = u'2015, Abigail S McGovern'
author = u'Abigail S McGovern'
...
man_pages = [
    (main_doc, 'napari-cookiecutterplugin_name', u'iterseg Documentation',
     [author], 1)
]
